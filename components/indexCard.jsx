...
import AddToTripDrawer from '@/app/site/custom/components/addtotrip/addtotripdrawer'
        ...
        <div className="relative w-full group">
          ...
          <div className="absolute inset-0 bg-black/0 group-hover:bg-black/10 transition-all duration-300">
            ...
            <button
              ...
              className="absolute top-2 left-2 bg-white/20 backdrop-blur-lg p-2 rounded-full transition-all duration-300 opacity-0 group-hover:opacity-100 hover:bg-white/30"
            >
              <Heart
                size={15}
            ...
            {/* 評分 - 右上角,hover 時顯示 */}
            <div className="absolute top-2 right-2 px-2.5 py-1.5 bg-white/20 backdrop-blur-lg rounded-full flex items-center gap-1 transition-all duration-300 opacity-0 group-hover:opacity-100">
            ...
            {/* 景點名稱和地點 - hover 時從底部滑入 */}
            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/60 via-black/40 to-transparent p-2.5 transition-all duration-300 translate-y-full group-hover:translate-y-0 opacity-0 group-hover:opacity-100">
            ...
            {/* 加入行程按鈕 - 右下角,hover 時顯示 */}
            <button
              onClick={handleAddToTripClick}
              className="absolute bottom-2 right-2 bg-white/20 backdrop-blur-lg p-2 rounded-full transition-all duration-300 opacity-0 group-hover:opacity-100 hover:bg-white/30"
            >
