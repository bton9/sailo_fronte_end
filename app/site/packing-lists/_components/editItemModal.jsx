 ...
 * Modal form for editing an existing item name
 */
...
export default function EditItemModal({
  ...
  onClose,
  onSubmit,
  currentName = '', // The current name of the item being edited
  categoryName = '', // Optional: to show which category the item belongs to
}) {
